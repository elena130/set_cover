...
unsigned SetCover::fix_essential_columns(const bool first_red, const std::vector<bool> & modified_rows) {
...
unsigned SetCover::fix_out_dominated_cols(const bool first_red, const std::vector<bool> & modified, const Logger logger) {
